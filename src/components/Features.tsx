  ...
  const features = [
    {
      ...
      description: "Advanced algorithms analyze market trends and patterns in real-time to identify profitable trading opportunities.",
      icon: (
    ...
    },
    {
      ...
      description: "Set your strategy and let our bot execute trades automatically 24/7, never missing an opportunity.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Advanced risk management features including stop-loss, take-profit, and position sizing algorithms.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Monitor your portfolio performance with detailed analytics and real-time reporting.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Create and customize your own trading strategies using our intuitive strategy builder.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Bank-grade encryption and security measures to protect your assets and trading activities.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Our advanced trading bot combines cutting-edge technology with user-friendly features to give you the edge in Solana trading.
          </p>
        </motion.div>
